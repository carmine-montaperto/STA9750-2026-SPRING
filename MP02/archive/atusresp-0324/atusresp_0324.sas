...
*;
data atusresp_0324;
infile "c:\atusresp_0324.dat" firstobs=2 dsd missover lrecl=16384 dlm=",";
length
TUCASEID $14 
TULINENO 8
TESPUHRS 8
...
label TEERNPER = "Edited: for your main job, what is the easiest way for you to report your total earnings before taxes or other deductions: hourly, weekly, annually, or some other way?";
...
label TRTALONE = "Total time respondent spent alone (in minutes)";
label TRTALONE_WK = "Total work- and nonwork-related time respondent spent alone (in minutes)";
label TRTCC = "Total time spent during diary day providing secondary childcare for household and own nonhousehold children < 13 (in minutes)";
...
label TRTCCTOT = "Total time spent during diary day providing secondary childcare for all children < 13 (in minutes)";
label TRTCHILD = "Total time respondent spent with household or nonhousehold children < 18 (in minutes)";
label TRTCOC = "Total time spent during diary day providing secondary childcare for nonown, nonhousehold children < 13 (in minutes)";
label TRTEC = "Total time spent providing eldercare (in minutes)";
label TRTFAMILY = "Total time respondent spent with family members (in minutes)";
label TRTFRIEND = "Total time respondent spent with friends (in minutes)";
label TRTHH = "Total time spent during diary day providing secondary childcare for household children < 13 (in minutes)";
label TRTHHFAMILY = "Total time respondent spent with household family members (in minutes)";
label TRTNOCHILD = "Total time respondent spent with nonown children < 18 (in minutes)";
label TRTNOHH = "Total time spent during diary day providing secondary childcare for nonown household children < 13 (in minutes)";
label TRTO = "Total time spent during diary day providing secondary childcare for own children < 13 (in minutes)";
label TRTOHH = "Total time spent during diary day providing secondary childcare for own household children < 13 (in minutes)";
label TRTOHHCHILD = "Total time respondent spent with own household children < 18 (in minutes)";
label TRTONHH = "Total time spent during diary day providing secondary childcare for own nonhousehold children < 13 (in minutes)";
label TRTONHHCHILD = "Total time respondent spent with own nonhousehold children < 18 (in minutes)";
label TRTSPONLY = "Total time respondent spent with spouse only (in minutes)";
label TRTSPOUSE = "Total time respondent spent with spouse (others may be present) (in minutes)";
label TRTUNMPART = "Total time respondent spent with unmarried partner (others may be present) (in minutes)";
...
label TUDIS = "Last time we spoke to someone in this household you were reported to have a disability. Does your disability prevent you from doing any kind of work for the next six months?";
...
label TUELDER = "Not including financial assistance or help you provided as part of your paid job, since the first of [REF_MONTH], have you provided any care or assistance for an adult who needed help because of a condition related to aging?";
...
label TUIODP1 = "Last time we spoke to someone in this household, you were reported to work for (employer's name). Do you still work for (employer's name)? (main job)";
label TUIODP2 = "Have the usual activities and duties of your job changed since (month of CPS interview)? (main job)";
label TUIODP3 = "Last time we spoke to someone in this household, you were reported as (occupation) and your usual duties were (activities). Is this an accurate description of your current job? (main job)";
...
label TU20FWGT = "ATUS final weight with method used for 2020 pandemic";
run;
...
5 = "Unable to work"
;
proc contents data=atusresp_0324; run;
